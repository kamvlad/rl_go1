...
class PolicyState:
    ...
    def process(self, state):
        ...
        return command.Command(q=action, Kp=[self.Kp]*12, Kd=[self.Kd]*12), self
...
def main(args):
    ...
    forward = PolicyState('src/models')
    backward = PolicyState('src/backward')
